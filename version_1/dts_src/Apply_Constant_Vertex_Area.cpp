...
Apply_Constant_Vertex_Area::Apply_Constant_Vertex_Area()
{
    m_State = false;

}
Apply_Constant_Vertex_Area::Apply_Constant_Vertex_Area(bool State, int eqsteps, double gamma,  double K0)
{
    double pi = acos(-1);
    ...
    {
    std::cout<<"---> error in constant area; gamma is bad; it should be a number between 0-1 \n";
    exit(0);
    }
    if(State==true)
    {
    std::cout<<"---> error: applying constant vertex is not fully working. \n";
    exit(0);
    }
...
double Apply_Constant_Vertex_Area::AreaofTrianglesAroundVertex(vertex *pv)
{
    double A=0.0;
...
//==========================================================
void Apply_Constant_Vertex_Area::Initialize(std::vector<triangle *> pTriangle)
{
    double A=0.0;
...
double Apply_Constant_Vertex_Area::GetEnergyChange(int step, double oldarea, double newarea)
{
...
void Apply_Constant_Vertex_Area::UpdateArea(double oldarea,  double newarea)
{
