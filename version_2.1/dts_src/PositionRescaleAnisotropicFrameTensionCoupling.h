#if !defined(AFX_PositionRescaleAnisotropicFrameTensionCoupling_H_DD4B21B8_C13C_5648_BF23_344095086239__INCLUDED_)
#define AFX_PositionRescaleAnisotropicFrameTensionCoupling_H_DD4B21B8_C13C_5648_BF23_344095086239__INCLUDED_
...
class State;
class PositionRescaleAnisotropicFrameTensionCoupling : public AbstractDynamicBox {
public:
    
    PositionRescaleAnisotropicFrameTensionCoupling(int period, double tau1, double tau2, double tau3, std::string direction, State *pState);
	~PositionRescaleAnisotropicFrameTensionCoupling();

    void Initialize();
    bool ChangeBoxSize(int step);

    inline  std::string GetDerivedDefaultReadName()  {return "AnisotropicFrameTension";}
    inline  static std::string GetDefaultReadName()  {return "AnisotropicFrameTension";}
