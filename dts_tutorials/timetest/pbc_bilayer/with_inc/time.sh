...
set terminal postscript enhanced color solid eps 16 size 5 ,10  font "Times-Roman, 16" #font 'UTF-8'#font 'Times-Roman' #30 #font 'Verdana,10'
...
plot "inc_time_ms.xvg" u  1:(2*($3-0.5)*$2) t 'inc move'
plot "box_time_ms.xvg" u  1:(2*($3-0.5)*$2) t 'box move'
