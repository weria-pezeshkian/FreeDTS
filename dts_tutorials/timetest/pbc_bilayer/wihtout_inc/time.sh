...
set terminal postscript enhanced color solid eps 16 size 3 ,3  font "Times-Roman, 16" #font 'UTF-8'#font 'Times-Roman' #30 #font 'Verdana,10'
...
plot "link_time_ms.xvg" plot 1:(2*(0.5-$3)*$2), t "link flip"
plot "vertex_time_ms.xvg" plot 1:(2*(0.5-$3)*$2), t "link flip"
plot "inc_time_ms.xvg" plot 1:(2*(0.5-$3)*$2), t "link flip"
