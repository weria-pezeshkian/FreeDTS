...
void SpringPotentialBetweenTwoGroups::MovingVertex(vertex* v, Vec3D Dx)
{
    ...
    if(v->GetGroupName() == m_Group1Name)
    {
        ...
        Vec3D g1 = COMVertexGroup(m_pGroup1);
        Vec3D g2 = COMVertexGroup(m_pGroup2);
    std::cout<<m_Group1COG(0)<<"  "<<m_Group1COG(1)<<"  "<<m_Group1COG(2)<<"  cog from book keeping \n";
        std::cout<<g1(0)<<"  "<<g1(1)<<"  "<<g1(2)<<"  3 cog from direct\n";
    std::cout<<m_Group2COG(0)<<"  "<<m_Group2COG(1)<<"  "<<m_Group2COG(2)<<"  2 \n";
        std::cout<<g2(0)<<"  "<<g2(1)<<"  "<<g2(2)<<"  4 \n";
    }
    if(v->GetGroupName() == m_Group2Name)
    {
        Vec3D g1 = COMVertexGroup(m_pGroup1);
        Vec3D g2 = COMVertexGroup(m_pGroup2);
        std::cout<<m_Group1COG(0)<<"  "<<m_Group1COG(1)<<"  "<<m_Group1COG(2)<<" cog from book keeping 1a \n";
        std::cout<<g1(0)<<"  "<<g1(1)<<"  "<<g1(2)<<"  cog from direct 3 \n";
        std::cout<<m_Group2COG(0)<<"  "<<m_Group2COG(1)<<"  "<<m_Group2COG(2)<<"  2 \n";
        std::cout<<g2(0)<<"  "<<g2(1)<<"  "<<g2(2)<<"  4 \n";
        std::cout<<Dx(0)<<"  "<<Dx(1)<<"  "<<Dx(2)<<"  5 \n";
    }
#endif
}
