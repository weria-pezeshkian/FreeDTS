#if !defined(AFX_InclusionTracking_H_334B21B8_C13C_2248_BF23_124095086233__INCLUDED_)
#define AFX_InclusionTracking_H_334B21B8_C13C_2248_BF23_124095086233__INCLUDED_
#include <complex>
#include "SimDef.h"
#include "vertex.h"
#include "triangle.h"
...
class State;
class InclusionTracking {
public:
    InclusionTracking(State* pState);
	 ~InclusionTracking();
