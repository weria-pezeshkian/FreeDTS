...
# Define your arrays
core=np.array([5.049,6.016, 6.999, 7.999,8.496,8.694, 8.999,9.164, 9.273]) #core radius at that frame
...
Restart_Period = 1000".format(MCsteps,kappa[i],core[j]))
            ...
            # Create and write to run.sh, a run files for an HPC environment; modify the paths correctly!
