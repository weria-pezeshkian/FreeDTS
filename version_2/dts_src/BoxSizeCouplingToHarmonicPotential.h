#if !defined(AFX_BoxSizeCouplingToHarmonicPotential_H_DD4B21B8_C13C_5648_BF23_344095086255__INCLUDED_)
#define AFX_BoxSizeCouplingToHarmonicPotential_H_DD4B21B8_C13C_5648_BF23_344095086255__INCLUDED_
...
class State;
class BoxSizeCouplingToHarmonicPotential : public AbstractDynamicBox {
public:
    
    BoxSizeCouplingToHarmonicPotential(int period, double K, double A0, std::string direction, State *pState);
	~BoxSizeCouplingToHarmonicPotential();
